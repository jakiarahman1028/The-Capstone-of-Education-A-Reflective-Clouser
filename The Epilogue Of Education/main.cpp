...
void introduction() {
	...
	// Story Title
	print("The Capstone of Education",
		1, 1, 1, title_fade, 310, 460, .3, .3, 3);
	print("A reflective Closure",
		1, 1, 1, title_fade, 390, 400, .3, .3, 3);
	print("by Group D",
		1, 1, 1, title_fade, 790, 345, .15, .15, 1);
	print("(C201211, C201231, C201234)",
...
void PUC_drawBoard() {
	...
	print("Bangladesh Navy College",
		1, 1, 1, 1, 460, 690, .2, .2, 3);

	print("CHITTAGONG",
		1, 1, 1, 1, 605, 630, .17, .17, 2);
}
...
void PUC() {
	...
	print("Some students choose Science, some choose Commerce, and some...",
...
void EC_drawBoard() {
	...
	print("Int. Islamic University Chittagong",
		1, 1, 1, 1,
		520, 715,
		.1, .1,
		2);

	print("Combined Quality with Morality",
		1, 1, 1, 1,
		540, 690,
		.1, .1,
		1);
...
int main(int argc, char **argv) {
	...
	glutCreateWindow("The Capstone of Education");

	//PlaySound(TEXT("KHALASI.wav"), NULL, SND_FILENAME | SND_SYNC);
